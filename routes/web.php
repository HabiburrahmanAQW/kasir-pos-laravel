...
Route::get('/', [App\Http\Controllers\HomeController::class, 'index'])->name('cetak-invoice');
...
//cetak
Route::get('/cetak-invoice', 'App\Http\Controllers\MenuController@cetakInvoice')->name('cetak-invoice');